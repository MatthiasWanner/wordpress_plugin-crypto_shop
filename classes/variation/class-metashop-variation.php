 ...
 * 
 * Will Modify Original WC_Product_Variable class to add custom properties.
 */
class MetaShopVariation {
    private $data;

    /**
     * MetaShopVariation constructor
     * @param object $original_data. Instance of WC_Product_Variable
     */
    ...
    /**
     * Method to retrieve the variation images from the database
     * Use metas generated by WooCommerce Additional Variation Images plugin
     * @return array of VariationImage instances
     */
    ...
    /**
     * Method to set a product variation thumbnail
     * @return string url of image thumbnail
     */
